...
describe('completion', () => {
    ...
    beforeAll(async () => {
        ...
        [client, server] = setupClientServer(false);
    ...
    it('local module completion with non-matchable prefix', async () => {
        const completion = await client.sendRequest<CompletionList>(
            'textDocument/completion',
            {
                textDocument: {
    ...
    it('local module completion with matchable prefix', async () => {
        const completion = await client.sendRequest<CompletionList>(
            'textDocument/completion',
            {
                textDocument: {
    ...
    it('local module completion with full ident', async () => {
        const completion = await client.sendRequest<CompletionList>(
            'textDocument/completion',
            {
                textDocument: {
